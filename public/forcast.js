var predictchartcanvas = document.getElementById('forcastcanvas').getContext('2d');

var predictChart = new Chart(predictchartcanvas, {
    type: 'line',
    data: {
        // labels: [1, 2, 3, 4, 5, 6],
        // datasets: [
...
function predictAQI()
{
    var inpf = document.getElementById('aqipredictinp');
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            //let dtSet = new Set(predictChart.data.labels);
            for(let i=0; i<dataobj.length; i+=3)
            {
            ...
            predictChart.data.labels = dataArrTimeLables;
            ...
            //     data: dataArrAQIXY
            // });
            predictChart.data.datasets = [];
            predictChart.data.datasets.push({
                label: data.city_name,
                fill: false,
    ...
    let path = `https://api.weatherbit.io/v2.0/forecast/airquality?postal_code=${query}&key=4e2ecb4fa34c4b8699cfe3f478f69818`;
